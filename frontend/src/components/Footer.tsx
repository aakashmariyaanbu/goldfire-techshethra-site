        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12 px-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#events" className="text-gray-400 hover:text-gold transition-colors">Events</a></li>
              <li><a href="#speakers" className="text-gray-400 hover:text-gold transition-colors">Speakers</a></li>
              <li><a href="#schedule" className="text-gray-400 hover:text-gold transition-colors">Schedule</a></li>
              <li><a href="#sponsors" className="text-gray-400 hover:text-gold transition-colors">Sponsors</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-gold transition-colors">Past Events</a></li>
              <li><a href="#" className="text-gray-400 hover:text-gold transition-colors">Venue Information</a></li>
              <li><a href="#" className="text-gray-400 hover:text-gold transition-colors">Accommodation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-gold transition-colors">Press Kit</a></li>
            </ul>
          </div>
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            &copy; 2025 TechShethra. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-gold text-sm">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-gold text-sm">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-gold text-sm">Code of Conduct</a>
          </div>
        </div>
      </div>
